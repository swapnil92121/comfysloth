...
import hero_bcg_2_78991864 from '../images/hero-bcg-2.78991864.jpeg'
import hero_bcg_a876f19f from '../images/hero-bcg.a876f19f.jpeg'
import '../css/Home.css'
import { useSelector } from 'react-redux'
import { Buttons } from '../components/Buttons'
import { Featured_Products } from '../components/Featured_Products'
import { Home_page_block_3 } from '../components/Home_page_block_3'
...
export const Home_Page = () => {
    const { All_Product } = useSelector(store => store.fetchData)
    ...
    return (
        <>
                ...
                {/* block_1 */}
                <div className='Home_page_block_1'>
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col" id='col_2'>
                                ...
                                <img className='Home_page_block_1_container_col_2_img_2' src={hero_bcg_2_78991864} />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                {/* block_2 */}
                <Featured_Products All_Product={All_Product}/>


                {/* block_3 */}
                <Home_page_block_3 data={data}/>


                {/* block_4 */}
                <section className="Home_page_block_4">
